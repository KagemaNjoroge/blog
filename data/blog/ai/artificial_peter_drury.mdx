---
title: "Let's build an Artificial Peter Drury using AI"
date: '2023-09-18'
tags: ['Artificial Intelligence', 'AI', 'Technology', 'Pytorch', 'Python']
draft: false
summary: Explore the world of AI and technology in this blog as we create an Artificial Peter Drury using Python & Pytorch. Witness the magic of AI as we replicate the iconic commentary style of Peter Drury.
---
...
**Attention Mechanism**  
We need our model to know the context of our data, to add an attention mechanism, we will use the Transformer architecture. Read more about [Attention is all you need](https://arxiv.org/abs/1706.03762)
...
You can find all the code and resources in [Github](https://github.com/KagemaNjoroge/Peter-Drury-Commentary-Generator/)
